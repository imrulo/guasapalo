...
function variantClass(variant: Variant): string {
  switch (variant) {
    case "amber":
      return "inline-flex min-h-12 items-center justify-center px-6 text-[0.9375rem] font-medium tracking-wide bg-amber text-night transition-colors duration-200 hover:bg-cream";
    case "line":
      return "inline-flex min-h-12 items-center justify-center px-6 text-[0.9375rem] font-medium tracking-wide border border-amber bg-transparent text-cream transition-colors duration-200 hover:bg-amber hover:text-night";
    case "ghost":
